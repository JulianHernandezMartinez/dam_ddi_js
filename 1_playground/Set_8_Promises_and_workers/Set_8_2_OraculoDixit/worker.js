...
let hasPosted = false;  // Flag to track whether a post has already been made

// Listen for messages from the main script
self.onmessage = function(event) {
    console.log('Received message in the worker:', event.data);

    // Check if a post has already been made
    if (!hasPosted) {
        hasPosted = true;
        ...
        console.log('Post already made in the worker.');
    }
};
